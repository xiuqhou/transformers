...
try:
    ...
    _import_structure["models.relation_detr"].extend(["RelationDetrImageProcessor", "RelationDetrImageProcessorFast"])
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.relation_detr import RelationDetrImageProcessor, RelationDetrImageProcessorFast
